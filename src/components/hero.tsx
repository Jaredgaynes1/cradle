  ...
  return (
    <div className="text-center overflow-hidden">
      <div className="relative flex h-[800px] sm:h-[800px] md:h-screen w-full flex-col items-center justify-center px-4">
        <div className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold break-words text-black z-50 md:mb-4 sm:mb-8 md:mt-40 sm:mt-20 sm:mb-10 max-w-full">
          <Highlight>Supercharge</Highlight> your Marina
        </div>
        <div className="z-50 p-4 w-full">
          <div className="text-base sm:text-lg md:text-2xl lg:text-3xl mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed text-gray-700">
            {HERO_SUBHEADLINE}
          </div>
